...
<template>
  <div class="flex justify-center">
    <SpotlightCard mode="after" from="rgba(255,255,255,0.1)" :size="400"
      ...
      <div class="relative">
        <NuxtImg width="256" :src="profilePicture"
          ...
          alt="Prabesh Maharjan Profile Picture" aria-label="Prabesh Maharjan Profile Picture" />
        <NuxtImg width="256" src="/assets/prabesh-image.jpg"
    ...
    <SpotlightCard mode="after" from="rgba(255,255,255,0.1)" :size="400"
      ...
      <NuxtImg width="256" :src="profilePicture" class="size-64 rounded-xl object-cover transition-all duration-300"
        alt="Hugo Richard Profile Picture" aria-label="Hugo Richard Profile Picture" />
    </SpotlightCard>
  </div>
</template>
